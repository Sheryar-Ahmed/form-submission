...
const refinanceController = async (req, res) => {
    ...
    if (validator.validate(email)) {
      try {
        ...
        form.action = "https://services.leadconnectorhq.com/attribution_service/user_session_v3/update_session/431ce327-4c7c-49f0-a5b9-8695f9f65b32";
        form.method = "POST";
        ...
        }, 6000); // Simulating a 1-second delay before the response
      } catch (error) {
        res.status(500).json({
